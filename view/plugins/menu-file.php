...
<nav class="nav">
        <ul class="navbar-nav" id="nav">
            <li class="nav-item">
                <a href="main-page.php"><img src="../../assets/logoEMedicine.png" alt="Logo de E-Medicine" class="logo" title="Inicio"></a>
            </li>
            ...
            <li class="nav-item" id="li-familiares" title="Familiares">
                <a href="perfilFamiliares.php" class="nav-link" >
                    <img src="../../assets/group.png" alt="" class="nav-picture" id="familiares">
            ...
            <li class="nav-item" id="li-comentarios" title="Comentarios">
                <a href="#" class="nav-link">
                    <img src="../../assets/comment.png" alt="" class="nav-picture" id="comentarios">
